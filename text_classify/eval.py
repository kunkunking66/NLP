...
@torch.no_grad()
def run(
        model_path, eval_path, batch_size, tokens, output_dir=Path("output/01"), **kwargs
):
...
def get_parser():
    ...
    parser.add_argument('-model_path', type=str, default=r"./output/02/models/net_9.pkl", help='给定json token路径')
    ...
    parser.add_argument('-output_dir', type=str, default='./output/02', help='输出文件夹路径')
    return parser
